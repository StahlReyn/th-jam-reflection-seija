...
func _physics_process(delta: float) -> void:
	if displaying_bonus:
		control_bonus.modulate.a = lerp(control_bonus.modulate.a, 1.0, delta * 10.0)
	if displaying_timer:
		control_timer.modulate.a = lerp(control_timer.modulate.a, 1.0, delta * 10.0)
	if displaying_chapter:
		control_chapter.modulate.a = lerp(control_chapter.modulate.a, 1.0, delta * 10.0)
	else:
		control_chapter.modulate.a = lerp(control_chapter.modulate.a, 0.0, delta * 10.0)
